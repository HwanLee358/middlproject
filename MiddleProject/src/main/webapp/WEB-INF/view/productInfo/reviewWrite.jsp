...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    ...
    <div class="v5_41">
        <form action="reviewWrite.do" method="post" enctype="multipart/form-data">
            ...
            <div class="v5_49">
                <input type="text" name="title" placeholder="Review Title" class="v5_49" required>
            </div>
            ...
            <div class="v5_51">
                <textarea name="content" placeholder="Review Content" class="v5_67" required></textarea>
            </div>
            
            <div class="v5_52">
                <span class="v5_55">5</span>
