	...
	<div class="list_normal">
		<div class="ec-base-product">
			<ul class="prdList grid4">
				<c:forEach var="BestList" items="${WearBest }" begin="0" end="7">
					<li id="" class="xans-recode-">
						<div class="thumbnail">
							<div class="prdlmg">
								<a href="productDetail.do?pno=${BestList.productNo }"><img
									src="images/wear/${BestList.productImg }.webp" id="" alt=""></a>
							</div>
							<div class="icon">
								<div class="button">
									<span data-product_no="${BestList.productNo }"> <img
										src="images/icon_202204071148303300.png"
										class="icon_img ec-product-listwishicon"
										alt="${BestList.productImg }" onclick='insertWishList()'>
									</span>
								</div>
							</div>
						</div>
						<div class="description">
							<strong class="name"> <a
								href="productDetail.do?pno=${BestList.productNo }"> <span
									class="title displaynone"></span> <b> <span
										style="font-size: 12px; color: #555555;">${BestList.productName }</span><b></b>
								</b>
							</a>
							</strong>
							<ul class="xans-element- xans-product xans-product-listitem spec">
								<li class="xans-record-">
									...
									<fmt:formatNumber>${BestList.productPrice }</fmt:formatNumber>
									</span>
								</li>
								<!-- 
